...
public class Dogs extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String name = request.getParameter("perro");
		String breed = request.getParameter("razaPerro");
		double weight = Double.parseDouble(request.getParameter("pesoPerro"));
		
		//modelo
		Dog dog1 = new Dog(name,breed,weight);
		
		// obtener modelo para la vista
		request.setAttribute("Dogs", dog1);
